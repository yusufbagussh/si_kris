...
return [
    ...
    */
    ...
    'edc_address' => env('EDC_WEBSOCKET_ADDRESS', 'localhost'), //10.100.3.11
    // EDC Address (Port of the EDC device)
    'edc_port' => env('EDC_WEBSOCKET_PORT', '6745'),
    // POS Address (IP of the POS/application/APM App)
    'pos_address' => env('EDC_POS_WEBSOCKET_ADDRESS', 'localhost'), //192.167.4.250
